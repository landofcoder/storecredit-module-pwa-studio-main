...
const ProductFullDetail = props => {
    ...
    const talonProps = useProductFullDetail({
        ...
        addStoreCreditProductsToCartMutation:ADD_STORE_CREDIT_MUTATION,
        product
    });
    const {
    ...
    const classes = mergeClasses(defaultClasses,inputStyle, props.classes);
    ...
    const inputStoreCredit = product.__typename ===  'StoreCreditProduct' ?(
